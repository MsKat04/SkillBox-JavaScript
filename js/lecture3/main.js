const api ={
    ...
    key: 'f0056edb42009c6794e7d325eafd791d'
}
...
const timerBuilder = (t) =>{
    const timer = t.getHours() +":" + t.getMinutes();
    return `${timer}`;
}

const input = document.querySelector('.searchbar');
const container = document.querySelector('.location-conteiner');
...
<div class = "timer"> ${timerBuilder(new Date())}</div>`
}
